...
setwd(cur_dir)
write.table(results2D, paste0("modeldata_results_auto/2D_",M,"repeats_sigma_eq_",sigma_true,".txt"))

results.data <- data.frame(coef_y_2D = sqrt(sigma.mult3))
write.table(results.data, paste0("modeldata_results_auto/data/2D_",M,"repeats_sigma_eq_",sigma_true,".txt"))

results.data.prop <- data.frame(prop.corr,prop.mean, prop.sd, prop.lm.coef, prop.lm.pvalue, prop.cos)
write.table(results.data.prop, paste0("modeldata_results_auto/data/prop_2D_",M,"repeats_sigma_eq_",sigma_true,".txt"))
