...
setwd(cur_dir)
write.table(results1D, paste0("modeldata_results_auto/1D_",M,"repeats_mult_sig_eq_", sigma_y_mult_sq, ".txt"))

results.data <- data.frame(coef_y = sqrt(coef_mult_y), coef_x=sqrt(coef_mult_x) )
write.table(results.data, paste0("modeldata_results_auto/data/1D_",M,"repeats_mult_sig_eq_", sigma_y_mult_sq, ".txt"))
